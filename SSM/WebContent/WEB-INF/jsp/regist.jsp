...
<body>
	<div class="w" id="regist">
		<div class="mt">
			...
			<div class="extra">
				<span>我已经注册，现在就&nbsp; <a
					href="<%=request.getContextPath()%>/tz?name=login" class="flk13">登录</a>
				</span>
			</div>
		</div>
		<div class="mc">
			<form method="post"  class="form-actions" action="regist" name="user">
				<div class="form">
					<div class="item">
					...
					<div class="item">
						...
						<div class="fl item-ifo">
							<input type="password" name="repassword" class="text"  id="repassword"
								required="required" onblur="CheckForm()" />
						</div>
					</div>
