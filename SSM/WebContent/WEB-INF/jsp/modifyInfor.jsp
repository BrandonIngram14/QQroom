...
<link type="text/css" rel="stylesheet" href="static/css/regist.personal.css" />
	...
	<div class="easyui-tabs" style="width:850px;height:600px;">
		<div title="修改密码"  style="padding:10px;" >
			<div class="w" id="regist" style="width:830px;">
				<div class="mc">
					<form method="post"  action="updatepwd" class="form-actions" target="_bank" onsubmit="return CheckForm();">
						<div class="form">
					        <div class="item">
				 ...
				 <div class="w" id="regist" style="width:830px;">
					<div class="mc">
						<form method="post"  class="form-actions"
							action="updateUser" target="iframepage">
							<div class="form">
								<div class="item">
									<span class="label"><b class="ftx04">*</b>昵称：</span>
									<div class="fl item-ifo">
								...
								<div class="item">
									<span class="label"><b class="ftx04">*</b>性别：${user.sex}</span>
									<div class="fl item-ifo">
										<label for="boy">男</label> 
										<input type="radio" id="boy" name="sex" value="1" <c:if test="${user.sex==1}"> checked="checked" </c:if>  required="required" /> 
										<label for="girl">女</label> 
										<input type="radio" id="girl" name="sex" value="0" <c:if test="${user.sex==0}"> checked="checked" </c:if> required="required" />
									</div>
								</div>
								...
								<div class="item">
									...
									<div class="fl item-ifo">
										...
										<input type="radio" id="no" value="0" name="ismarry" <c:if test="${user.ismarry==0}"> checked="checked" </c:if>/>
										<label for="yes">是</label> 
										<input type="radio" id="yes" value="1" name="ismarry" <c:if test="${user.ismarry==1}"> checked="checked" </c:if>/> 
										<label for="secrecy">保密</label> 
										<input type="radio" id="secrecy" value="-1" name="ismarry" <c:if test="${user.ismarry==-1}"> checked="checked" </c:if>/>
									</div>
								</div>  
								...
								<div class="item">
									...
									<div class="fl item-ifo">
										<input type="date" name="birthday"   value="${user.birthday}" class="text" />
									</div>
								</div>
							 	<div class="item">
									<span class="label"><b class="ftx04"></b>家乡：</span>
									<div class="fl item-ifo">
										<input type="text" name="hometown"  value="${user.hometown }" class="text" />
									</div>
								</div>
								<div class="item">
									<span class="label"><b class="ftx04"></b>现在住址：</span>
									<div class="fl item-ifo">
										<input type="text" name="nowaddress" value="${user.nowaddress }"   class="text" />
									</div>
								</div> 
								<div class="item" >
									<div class="fl item-ifo">
