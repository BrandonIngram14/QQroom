			...
			<div class="right">  
			   <%--  <c:set var="users" value="${friendresult.getList()}" />
				...
				<c:if test="${!empty userss}">
					<c:forEach items="${userss}" var="user" varStatus="status">
						<div class="qquser">
							<img src="static/headpic/${user.headpic}" width="80" height="80"/> <br>昵称：${user.username} <br>QQ：${user.qq}
							<form action="addFriend" name="friend" method="post" >
